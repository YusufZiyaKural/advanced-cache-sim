...
This will create an executable file named `cache_sim` (or `cache_sim.exe` on Windows).
...
* **BLOCK_SIZE:** Size of a single block in bytes.
...
* **WRITE_ALLOCATE:** `1` for Write-Allocate, `0` for No-Write-Allocate.
